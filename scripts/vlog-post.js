...
const iconWebsite = `<svg viewBox="0 0 24 24" width="16" height="16" aria-hidden="true"><path fill="currentColor" d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm6.92 9h-3.09a15.6 15.6 0 0 0-1.14-5.03A8.02 8.02 0 0 1 18.92 11ZM12 4.04c.84 1.2 1.66 3.3 1.9 5.96h-3.8C10.34 7.34 11.16 5.24 12 4.04ZM4.08 13h3.09c.1 1.78.5 3.51 1.14 5.03A8.02 8.02 0 0 1 4.08 13Zm3.09-2H4.08a8.02 8.02 0 0 1 4.23-5.03A15.6 15.6 0 0 0 7.17 11Zm2.93 0c.24-2.66 1.06-4.76 1.9-5.96.84 1.2 1.66 3.3 1.9 5.96h-3.8Zm0 2h3.8c-.24 2.66-1.06 4.76-1.9 5.96-.84-1.2-1.66-3.3-1.9-5.96Zm4.59 5.03c.64-1.52 1.04-3.25 1.14-5.03h3.09a8.02 8.02 0 0 1-4.23 5.03Z"/></svg>`;
...
function renderSocials(socials) {
    ...
    if (socials.website) links.push(socialIconLink(socials.website, "Project website", iconWebsite));
